...
class UNetDropoutEmbedding(nn.Module):
    def __init__(self, in_channels, out_channels, base_filters, kernel_size, dropout_rate, embedding_dim):
        """Implementazione della U-Net 1D con blocchi modulari."""
        super().__init__()
        self.embedding = nn.Embedding(in_channels, embedding_dim)
        self.encoder1 = ConvBlock(embedding_dim, base_filters, kernel_size, dropout_rate)
...
def main():
    ...
    config_path = "m_unet_dropout_embedding.yaml"
